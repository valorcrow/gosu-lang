...
#=======================================================================================================================
#
#  NAME: update-all-local-git-branches.sh
#  AUTHOR(S): Joshua Thomas Brogan
#
#  PURPOSE: Use this script to update all local Git repository branches.
#
#=======================================================================================================================
#///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#=======================================================================================================================
...
echo -e ""
echo -e "=============================================================================================================="
echo -e "Executing branch update script: ${FG_LU_GREEN}update-all-local-git-branches.sh${FG_DEFAULT}"
echo -e "=============================================================================================================="
...
echo -e ""
echo -e "=============================================================================================================="
echo -e "Fetching the latest from origin..."
echo -e "=============================================================================================================="
echo -e ""
echo -e "*** INFO *** Executing command {${FG_L_YELLOW}git fetch origin${FG_DEFAULT}}"
git fetch origin

# Prune excess branches from origin
echo -e ""
echo -e "=============================================================================================================="
echo -e "Pruning excess branches from origin..."
echo -e "=============================================================================================================="
echo -e ""
echo -e "*** INFO *** Executing command {${FG_L_YELLOW}git remote prune origin${FG_DEFAULT}}"
git remote prune origin

# Pull the latest code changes from origin/master
echo -e ""
echo -e "=============================================================================================================="
echo -e "Pulling the latest code changes from origin/master..."
echo -e "=============================================================================================================="
echo -e ""
...
git checkout master
echo -e ""
echo -e "*** INFO *** Executing command {${FG_L_YELLOW}git pull origin master${FG_DEFAULT}}"
...
# Show the latest refs from origin
echo -e ""
echo -e "=============================================================================================================="
echo -e "Showing the latest refs from origin..."
echo -e "=============================================================================================================="
echo -e ""
echo -e "*** INFO *** Executing command {${FG_L_YELLOW}git remote show origin${FG_DEFAULT}}"
